...
openapi-generator-cxf-jaxrs-client-osgi-ds is currently built on top of JDK 11.
...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/openapi-generator-cxf-jaxrs-client-osgi-ds/issues/new/choose[issue form].
